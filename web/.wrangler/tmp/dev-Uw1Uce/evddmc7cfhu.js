...
// .wrangler/tmp/bundle-3SBvZX/checked-fetch.js
...
// .wrangler/tmp/pages-vsvVAs/bundledWorker-0.45926620745550717.mjs
...
var ce = /* @__PURE__ */ __name2((e, t, s, r) => {
  if (t && typeof t == "object" || typeof t == "function") for (let a of ae(t)) !_e.call(e, a) && a !== s && q(e, a, { get: /* @__PURE__ */ __name2(() => t[a], "get"), enumerable: !(r = ne(t, a)) || r.enumerable });
  return e;
}, "ce");
var V = /* @__PURE__ */ __name2((e, t, s) => (s = e != null ? se(oe(e)) : {}, ce(t || !e || !e.__esModule ? q(s, "default", { value: e, enumerable: true }) : s, e)), "V");
var l;
var p = C(() => {
  l = { collectedLocales: [] };
});
...
async function J(e) {
  ...
  try {
    ...
    switch (e.method) {
      case "GET": {
        let o = K(e, le), n = await r.get(a, { softTags: o });
      ...
      case "POST": {
        let o = globalThis[me], n = /* @__PURE__ */ __name2(async () => {
          let _ = await e.json();
          _.data.tags === void 0 && (_.tags ??= K(e, ge) ?? []), await r.set(a, _);
        }, "n");
...
// .wrangler/tmp/pages-vsvVAs/evddmc7cfhu.js
...
// .wrangler/tmp/bundle-3SBvZX/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-3SBvZX/middleware-loader.entry.ts
