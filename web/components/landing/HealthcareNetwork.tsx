...
const NODES: NetworkNode[] = [
  ...
  { id: "clinic", label: "Clinic", x: 15, y: 25, icon: "🩺", color: "#3b82f6", glow: "rgba(59,130,246,0.3)", connections: ["hospital", "patient"], description: "Primary care clinics" },
  { id: "patient", label: "Patient App", x: 85, y: 25, icon: "📱", color: "#f59e0b", glow: "rgba(245,158,11,0.3)", connections: ["clinic", "hospital", "cloud"], description: "Patient health portal" },
  ...
  { id: "cloud", label: "MediBridgeX", x: 50, y: 58, icon: "⚡", color: "#ec4899", glow: "rgba(236,72,153,0.4)", connections: ["hospital", "lab", "pharmacy", "insurance", "patient", "ambulance"], description: "Intelligent interoperability hub" },
...
export function HealthcareNetwork() {
  ...
  return (
    <div className="relative w-full max-w-[700px] aspect-[7/5] mx-auto">
      <svg viewBox="0 0 100 100" className="w-full h-full" style={{ filter: "drop-shadow(0 4px 20px rgba(0,0,0,0.04))" }}>
        <defs>
          ...
          node.connections.map(targetId => {
            ...
            return (
              <motion.line
                ...
                stroke={active ? "url(#lineGrad)" : "#e2e8f0"}
            ...
            >
              ...
              <motion.circle
                ...
                animate={{
                  ...
                  r: hoveredNode === node.id ? (isCenter ? 9 : 7) : (isCenter ? 7.5 : 5.5),
                }}
