...
export default function HMSPage() {
  const fhirFeatures = [
    ...
    },
    {
      ...
      description: 'Comprehensive patient records, scheduling, and history tracking.',
      icon: Activity,
    },
    {
    ...
    {
      title: 'FHIR Integrated',
      description: 'Unlike legacy systems, our HMS is natively connected to the MediBridgeX FHIR engine.',
      icon: Lock,
    },
  ];
    ...
    <div className="min-h-screen bg-white selection:bg-purple-100 selection:text-purple-900">
      ...
      <main>
        <FeatureHero
          ...
          description="A complete end-to-end HMS integrated directly into the MediBridgeX interoperability engine. Manage patients, billing, and scheduling seamlessly."
            ...
            <div className="lg:col-span-5 mb-12 lg:mb-0">
              <FadeIn>
                ...
                <ul className="space-y-4">
                  {['Billing & Invoicing', 'Automatic schema validation', 'Built-in rate limiting and throttling', 'Comprehensive audit trailing'].map((item, i) => (
